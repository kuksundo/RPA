object AddInModule: TAddInModule
  ...
  AddInName = 'CoOLMail4HiconisAS'
  Description = #49688#49888#54620' '#47700#51068#51012' MQ '#47196' '#49569#48512#54632
  ...
  object adxContextMenu2: TadxContextMenu
    ...
    Buttons = <
      item
        ...
        Temporary = True
        PropertyChanged = 1
        ButtonTypes = {06000000000000000000000000000000000000000000000000000000}
        Buttons = <
          item
            ...
            olInspectorItemTypes = [adxOLMail]
            Temporary = True
            OnClick = adxContextMenu2Controls0Controls0Click
            PropertyChanged = 1
          end
          item
            Caption = '-'
          ...
          item
            Caption = 'Copy Folder Name and StoreID'
          ...
          item
            Caption = 'Show email account'
            OfficeTag = '{D5681748-2F19-4AF9-B409-64180B87A81F}'
            olExplorerItemTypes = [adxOLMailItem]
            olInspectorItemTypes = [adxOLMail]
            Temporary = True
            OnClick = adxContextMenu2Controls0Controls3Click
            PropertyChanged = 1
          end
          item
            Caption = 'Show Folder Path'
            OfficeTag = '{6D9CC378-026E-4995-9FC6-C667FED1215B}'
            olExplorerItemTypes = [adxOLMailItem]
            olInspectorItemTypes = [adxOLMail]
            Temporary = True
            OnClick = adxContextMenu2Controls0Controls4Click
            PropertyChanged = 1
          end
          item
            Caption = 'Show Email Account info as json'
            OfficeTag = '{B58D60D6-DEA7-4DC5-B359-455A0F80325E}'
            olExplorerItemTypes = [adxOLMailItem]
            olInspectorItemTypes = [adxOLMail]
            Temporary = True
            OnClick = adxContextMenu2Controls0Controls5Click
            PropertyChanged = 1
          end>
      end>
    PropertyChanged = 1
