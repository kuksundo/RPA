...
type
  TCLO4HiMTech = class //CommandLineOption
    FProdCode64,
    FAppSigInfo64,
    FTagName,
    FDBName
  ...
  public
    ...
    class function CommandLineParse(var AHiMTechCLO: TCLO4HiMTech;
...
class function TCLO4HiMTech.CommandLineParse(var AHiMTechCLO: TCLO4HiMTech;
  var AErrMsg: string): boolean;
var
  LStr: string;
begin
  AErrMsg := '';
  AHiMTechCLO := TCLO4HiMTech.Create;
  try
//      CommandLineParser.Options := [opIgnoreUnknownSwitches];
    Result := CommandLineParser.Parse(AHiMTechCLO);
  except
